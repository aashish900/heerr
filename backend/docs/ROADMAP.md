...
**Status (2026-07-10):** Phases A–O complete. Phase O (song metadata edit, issue #44) shipped 2026-07-06 at `4.6.2`; `4.7.0` (2026-07-10) is the app-wide gradient redesign; `4.7.1` (2026-07-10) is a widget/tab visual polish pass (Android-side only — no backend changes; version bumped for sync).
