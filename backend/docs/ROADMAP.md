...
**Files modified:** `backend/docs/DECISIONLOG.md` (new ADR "Multi-user via Navidrome IdP — heerr backend v3.0.0-rc1"), `backend/docs/CONTEXT.md` (replace "single-user" line with multi-user / per-tailnet shape), `backend/docs/CHANGELOG.md` (J1–J10 entries), `backend/pyproject.toml` → `3.0.0-rc1`.
...
**Commit:** `chore(backend): J11 — multi-user ADR + CONTEXT/CHANGELOG + v3.0.0-rc1`
