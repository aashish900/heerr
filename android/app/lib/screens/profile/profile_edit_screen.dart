...
/// Profile edit form (#37, moved to `/profile/edit` at Z1): avatar
/// (add / change / remove), Name, Nickname, and a 100-word Bio. Every field
/// is optional — blank Name falls back to the Navidrome username, blank
/// Nickname/Bio persist as null.
///
...
class _ProfileEditScreenState extends ConsumerState<ProfileEditScreen> {
  ...
  Future<void> _save() async {
    ...
    // Z1: the edit form is pushed from the display profile screen — pop
    // back to it so the fresh values are visible immediately.
